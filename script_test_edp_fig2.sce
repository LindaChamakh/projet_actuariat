...
N_x_0 = 30;//nb de points pour x_0
N_r_0 = 30//nb de points pour r_0
...
xtitle('$BE/PM\ à\ t=0\ en\ (x_0,r_0)$')
xlabel("$x_0$","fontsize",6);
ylabel("$r_0$","fontsize",6);
zlabel("$\psi$","fontsize",6);
